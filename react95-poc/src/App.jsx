...
const APPS = {
  ...
  sapling: {
    title: "Sapling", iconNode: <SaplingIcon />, width: 256,
    titlebarBg: "linear-gradient(180deg,#39a552,#1f7a33)", titlebarColor: "#fff",
  },
  mario: {
    title: "super-artificial-bros", iconNode: <MarioIcon />, width: 256,
    titlebarBg: "linear-gradient(180deg,#e0392c,#b5231a)", titlebarColor: "#fff",
  },
  stalk: {
    title: "Stalk Market", iconNode: <StalkIcon />, width: 256,
...
const ABOUT_LINKS = [
  ...
  { href:"https://www.linkedin.com/in/jacklhe/",   icon:"/icon-linkedin.png", label:"linkedin.com/in/jacklhe",     sub:"Professional profile" },
            ...
            <TaskbarBtns>
              {Object.entries(wins).filter(([, w]) => w.open).map(([id]) => (
                <TaskbarWinBtn key={id} className={activeId === id && !wins[id].min ? "active" : ""} onClick={() => onTaskbarClick(id)}>
                  <img src={APPS[id].icon ?? "/projects.png"} alt="" />
